...
!(function () {
    var e = {
            _scheme: "auto",
            change: { light: "<i>Dark mode ON</i>", dark: "<i>Dark mode OFF</i>" },
        ...
        t = {
            ...
            onToggleClick() {
                this.toggleLink.addEventListener(
                    "click",
                    (e) => {
                        e.preventDefault(), "closed-on-mobile" == this.state ? (this.state = "open") : (this.state = "closed-on-mobile"), this.nav.removeAttribute("class"), this.nav.classList.add(this.state);
                    },
                    !1
                );
            },
